...
public static class LayerTransitionChecks
{
    ...
    public static object Main()
    {
        ...
        var preview=new MapGenerationSampler(source.registry,source.ActiveSeed,source.GeneratedHeight,source.layers,source.oreDensityCurve,source.oreDensityMultiplierPercent,source.transitionThickness);
        int checkedCells=0;
        ...
        try
        {
            ...
            var sampler=new MapGenerationSampler(registry,map.seed,map.mapHeight,map.layers,map.oreDensityCurve,map.oreDensityMultiplierPercent,map.transitionThickness);
